    ...
    <div className={styles.root}>
        ...
        <div className={styles.intro}>
          ...
          <p className={styles.location}>
            <svg viewBox="0 0 16 16" aria-hidden="true">
              <path d="M8 1.5c-2.7 0-4.8 2.1-4.8 4.8 0 3.4 4.8 8.2 4.8 8.2s4.8-4.8 4.8-8.2c0-2.7-2.1-4.8-4.8-4.8z" />
      ...
      <div className={styles.body}>
        ...
        <p className={styles.bio}>
          ...
          My office is supervised by Jiji, my black cat and code reviewer.
        </p>
        ...
        <div className={styles.socials}>
          ...
          <a
            href="https://x.com/Hawksworth101"
            target="_blank"
            rel="noreferrer"
            className={styles.socialBtn}
          ...
          <button
            className={styles.socialBtn}
            onClick={() => window.open('/JoshuaHawksworthCV.pdf', '_blank')}
          >
            <svg
              viewBox="0 0 24 24"
              fill="none"
