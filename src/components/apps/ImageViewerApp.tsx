    ...
    <div className={styles.root}>
      ...
      <div className={styles.toolbar}>
        ...
        <div className={styles.controls}>
          <button className={styles.toolBtn} onClick={zoomOut} title="Zoom out">
            −
          </button>
          <button className={styles.toolBtn} onClick={resetZoom} title="Fit to window">
            {fit ? '⊡' : `${Math.round(zoom * 100)}%`}
          </button>
          <button className={styles.toolBtn} onClick={zoomIn} title="Zoom in">
            +
          </button>
          <a href={dataUrl} download={filename} className={styles.downloadBtn} title="Download">
            <svg
              width="13"
              height="13"
              viewBox="0 0 14 14"
